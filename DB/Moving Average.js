...
class MovingAverage {
    ...
    next(num){
        if(this.arr.length==this.size){
            ...
            this.currentSum-=this.arr.shift()
        }
        this.currentSum+=num
        this.arr.push(num)
        return currentSum/this.arr.length
    }
}
...
//             console.log(key)
//             this.currentSum-= this.map.get(key)
//             this.map.delete(key)
//         }
//         this.currentSum+=num
//         this.map.set(num,num)
//         return this.currentSum/this.map.size
//     }
// }